...
public class ClassB {
	...
	public void run() {
		try {
			reader = new BufferedReader(new InputStreamReader(getClass().getResourceAsStream("test/files/basketball_input.txt")));
			tokenizer = null;
			out = new PrintWriter("output/basketball_output.txt");
			solve();
			reader.close();
			out.close();
		} catch (Exception e) {
